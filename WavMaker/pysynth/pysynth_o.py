...
"""
# modified to accept [['note', value, vol]] tuples
"""
...
# leg_stac is for compatibility with pysynth_b, not used in this function
def make_wav(song,bpm=120,transpose=0,pause=.05,boost=1.1,repeat=0,fn="out.wav", silent=False, vol_list=None, leg_stac=None):
    f=wave.open(fn,'w')
